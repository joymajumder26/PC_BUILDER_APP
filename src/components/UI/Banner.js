...
import PcImage from "@/assets/images/banner-images/Best-Custom-PC-Builder-Websites-2023.jpg";
import AnotherPcImage from "@/assets/images/banner-images/best-custom-pc-builder-website-1024x597.png";
    ...
    <div>
      <Row>
        ...
        <Col
          ...
          style={contentStyle}
        >
          <Image src={PcImage} layout="responsive" width={1200} height={800}  alt="drawing_image" />
        </Col>
      </Row>
    </div>
    {/* slider-2 */}
    <div>
      <Row>
        ...
        >
          <Image
            src={AnotherPcImage}
            layout="responsive" width={1200} height={800}
            // fill
            alt="eagle_image"
            style={{ grayScale: "-1" }}
          />
